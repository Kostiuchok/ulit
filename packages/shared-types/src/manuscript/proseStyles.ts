...
export const MANUSCRIPT_PROSE_CSS = `
      ...
      .manuscript-prose p[data-variant="titlepage-title"] {
        text-align: center; text-indent: 0; font-size: 18pt; font-weight: 700; margin: 0.3em 0 0; line-height: 1.3em;
      }
      ...
      .manuscript-prose p[data-variant="titlepage-subtitle"] {
        text-align: center; text-indent: 0; font-size: 16pt; font-weight: 400; margin: 0.2em 0 0; line-height: 1.3em;
      }
