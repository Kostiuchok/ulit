...
export const metadata: Metadata = {
  title: "Договір автора | ULIT",
  description: "Публічна оферта платформи ULIT — умови публікації та продажу книг для авторів.",
};
    ...
    <div className="pb-24">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 py-12">
        <div className="mb-10">
          ...
          <p className="text-sm text-gray-500">Публічна оферта про надання послуг платформи самовидавництва ULIT</p>
