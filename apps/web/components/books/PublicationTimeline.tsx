...
export function PublicationTimeline({
  ...
  // "PDF для друку" link (print-preview.ts) -- nothing else in the publish flow
        ...
        {creationExpanded && (
          <div className="ml-7 mb-4 -mt-3 space-y-1.5">
            ...
            <CreationSubItem
              ...
              tooltip={
                udkBlockedOnAuthor
                  ? "⚠ Очікування УДК ще не почалось: не згенеровано PDF для друку рукопису. Натисніть, щоб відкрити «PDF для друку» — це й запустить генерацію."
