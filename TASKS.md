...
- [ ] **T-501** Fabric.js canvas — компонент `CoverDesigner`
- [ ] **T-502** Завантаження власного зображення
- [ ] **T-503** Інструменти: текст, колір, шрифт, позиція
- [ ] **T-504** Unsplash API — безкоштовні фонові зображення
- [ ] **T-505** Готові шаблони (мінімум 5)
- [ ] **T-506** Експорт PNG (300 DPI)
- [ ] **T-507** `POST /api/books/:id/upload-cover` → MinIO

---

## 📡 ФАЗА 6 — Стратегія дистрибуції (KU vs Широке)

- [ ] **T-601** UI вибору стратегії на кроці 4 wizard (WIDE | KDP_SELECT)
- [ ] **T-602** Зберігати `distributionStrategy` + `kdpSelectExpiry` в БД
- [ ] **T-603** Логіка: якщо KDP_SELECT — при публікації знімати з D2D та сайту
- [ ] **T-604** Нотифікація автору за 7 днів до закінчення KDP Select (email job)
- [ ] **T-605** UI у кабінеті автора — статус ексклюзивності + дата закінчення
