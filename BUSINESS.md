...
## 6. Business model
Комісія платформи з продажів у магазині Ulit: **30%** (`PLATFORM_FEE_PERCENT`, default 30) — 70% автору, як у договорі. Поріг виплати в доках 500 UAH — підтвердити. Hold 7 днів. MVP-виплати вручну.
...
## 11. Finance (open)
Комісія 30% (канон). Відкрито: поріг виплати; ISBN cost; CAC автора; GMV.

## 12. Risks
Ручна дистрибуція; ISBN лише через Книжкову палату; E2E ще не блокує CI; bottleneck модерації; залежність від LiqPay.

## 13. Open decisions
Комісія 30% зафіксована; чи WayForPay в alpha exit; дата альфи; пул ISBN; канал авторів; синк цього файлу з Notion.
